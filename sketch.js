...
function setup(){
    ...
    bob1 = new Pendulum(100,300,30,"violet");
    bob1.debug=true;
    bob2 = new Pendulum(160,300,30,"indigo");
    bob3 = new Pendulum(220,300,30,"blue");
    bob4 = new Pendulum(280,300,30,"green");
    bob5 = new Pendulum(390,260,30,"yellow");
